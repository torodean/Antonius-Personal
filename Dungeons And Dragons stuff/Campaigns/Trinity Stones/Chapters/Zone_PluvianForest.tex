...
\begin{commentbox}{Aquaeleous}
	\begin{center}
	\includegraphics[width=0.8\linewidth]{img/waterdragon.jpg}
	\end{center}
	
	\begin{center}
	\includegraphics[width=0.8\linewidth]{img/maps/aquaeleous.jpg}
	\end{center}
\end{commentbox}
...
\begin{commentbox}{Crystalleous}
	\begin{center}
	\includegraphics[width=0.8\linewidth]{img/WoW/crystaldragon.jpg}
	\end{center}

	\begin{center}
	\includegraphics[width=0.8\linewidth]{img/maps/crystalleous.jpg}
	\end{center}
\end{commentbox}
