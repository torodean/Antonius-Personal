...
\begin{commentbox}{Aquaeleous}
	...
	\begin{center}
	\includegraphics[width=0.8\linewidth]{img/aquaeleous.jpg}
	\end{center}
\end{commentbox}
...
\begin{commentbox}{Crystalleous}
	\begin{center}
	\includegraphics[width=0.8\linewidth]{img/crystaldragon.jpg}
	\end{center}

	\begin{center}
	\includegraphics[width=0.8\linewidth]{img/crystalleous.jpg}
	\end{center}
\end{commentbox}
