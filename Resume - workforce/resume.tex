...
\cvitem{Programming}{\textsc{c}++, \textsc{c}\#, \textsc{python}, \textsc{php}, \textsc{java}, \textsc{git}, \textsc{bash}, \textsc{root}, \textsc{geant4}, \textsc{html}, \textsc{css}, \textsc{cad}, \LaTeX, LabVIEW, Qt, Cygwin, Makefiles}
...
\cventry{Summer 2018}{LabVIEW Programmer}{\textsc{Michigan State University}}{East Lansing MI}{}{
	\begin{itemize}
		\item Programming of experimental data acquisition systems for an advanced lab class at MSU for quantumn physics (optical pumping) and superfluidity experiments by integrating National Instruments I/O devices to a computer system.
