...
\cvitem{Languages}{\textsc{c}++, \textsc{python}, \textsc{c}\#, \textsc{java}, \textsc{git},  \textsc{bash}, \textsc{cmake}, \textsc{php}, \textsc{geant4}, \textsc{html}, \textsc{css}, \textsc{cad}, \LaTeX, Perforce, Qt, Eclipse, CLion, NetBeans, Cygwin, Makefiles, LabVIEW, Mathematica, TLS/SSL, Telnet, IBM MQ, Systemd, GDB}
