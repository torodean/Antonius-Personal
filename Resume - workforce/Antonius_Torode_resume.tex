...
\cvitem{Programming}{\textsc{c}++, \textsc{c}\#, \textsc{python}, \textsc{php}, \textsc{java}, \textsc{git},  \textsc{bash}, \textsc{root}, \textsc{geant4}, \textsc{html}, \textsc{css}, \textsc{cad}, \LaTeX, Perforce, LabVIEW, Qt, Eclipse, CLion, NetBeans, Cygwin, Makefiles, Mathematica}
