...
\cvitem{Programming}{\textsc{c}++, \textsc{c}\#, \textsc{python}, \textsc{php}, \textsc{java}, \textsc{git},  \textsc{bash}, \textsc{root}, \textsc{geant4}, \textsc{html}, \textsc{css}, \textsc{cad}, \LaTeX, Perforce, LabVIEW, Qt, Eclipse, CLion, NetBeans, Cygwin, Makefiles, Mathematica, TLS/SSL, Telnet, IBM MQ}
\cvitem{Systems}{Microsoft Windows (all modern), Linux (Ubuntu, Kali, Debian, CentOS, Fedora, Raspian, others), \textsc{Mac OS}, UNIX}
...
\cventry{2019--Pres}{Engineering Scientist Associate}{\textsc{Applied Research Laboratories}}{Austin, TX}{}{
	\begin{itemize}
		\item Programming and implementing new technologies used by satelite GPS systems. 
		\item Developed a standalone program, (Interfacing Data Application -IDA) to be used by the developers in assisting with visualizing binary data and performing common analysis tasks.
		\item Developed python scripts for performing communication via TLS/SSL connections.
\end{itemize}}
...
\begin{itemize}
\item My responsibilities included managing and fixing any computer related problems that may arise while maintaining or improving efficiency within multiple departments. These included problems such as setting up new experimental camera systems, restoring corrupted operating system files, recovering lost data, replacing damaged hardware, troubleshooting malfunctioning software and more.
\end{itemize}}
