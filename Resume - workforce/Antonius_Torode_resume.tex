...
\cvitem{Programming}{\textsc{c}++, \textsc{c}\#, \textsc{python}, \textsc{php}, \textsc{java}, \textsc{git}, \textsc{bash}, \textsc{root}, \textsc{geant4}, \textsc{html}, \textsc{css}, \textsc{cad}, \LaTeX, LabVIEW, Qt, Eclipse, NetBeans, Cygwin, Makefiles, Mathematica}
\cvitem{Systems}{Microsoft Windows (all), Linux, \textsc{Mac OS}, UNIX}
\cvitem{Software}{DS9, Stellarium, OpenOffice products, Microsoft Office Suite, Adobe (Premiere Pro, Illustrator, Photoshop, After Effects, Audition), Sony Vegas, Final Cut Studio, GIMP, PuTTY, Notepad++, FileZilla, VLC}
