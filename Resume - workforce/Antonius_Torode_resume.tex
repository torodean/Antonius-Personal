...
\cvitem{Languages}{\textsc{c}++, \textsc{python}, \textsc{c}\#, \textsc{java}, \textsc{git},  \textsc{bash}, \textsc{cmake}, \textsc{php}, \textsc{geant4}, \textsc{html}, \textsc{css}, \textsc{cad}, \LaTeX, Perforce, Qt, Eclipse, CLion, NetBeans, Cygwin, Makefiles, LabVIEW, Mathematica, TLS/SSL, Telnet, IBM MQ}
...
\cvitem{Software}{OpenOffice products, Microsoft Office Suite, Adobe (Premiere Pro, Illustrator, Photoshop, After Effects, Audition), TexStudio, DS9, Stellarium, Sony Vegas, Final Cut Studio, GIMP, PuTTY, Notepad++, FileZilla, VLC, OBS}
