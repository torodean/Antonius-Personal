...
Multidisciplinary scientist specializing in the analysis, design, and implementation of complex technical systems. Combines physics, mathematics, software engineering, and systems thinking to solve problems spanning scientific research, defense applications, automation, and product development. Experienced in rapidly acquiring new technical skills and translating them into reliable, maintainable solutions.
...
\cvitem{Development Technologies}{\textsc{c}++, \textsc{python}, \textsc{java}, \textsc{git},  \textsc{bash}, \textsc{cmake}, \textsc{c}\#, \textsc{php}, \textsc{html}, \textsc{css}, \textsc{cad}, \LaTeX, Perforce, Qt, \textsc{root}, \textsc{geant4}, Eclipse, CLion, NetBeans, Cygwin, \textsc{make}, LabVIEW, Mathematica, TLS/SSL, Telnet, IBM MQ, Apache Pulsar, Systemd, GDB}
\cvitem{Systems}{Linux (Ubuntu, RedHat, Kali, Debian, CentOS, Fedora, Raspian, others), Microsoft Windows (all modern), \textsc{Mac OS}, UNIX}
\cvitem{Software}{OpenOffice products, Microsoft Office Suite, Adobe (Premiere Pro, Illustrator, Photoshop, After Effects, Audition), TexStudio, DS9, Stellarium, Sony Vegas, Final Cut Studio, GIMP, PuTTY, Notepad++, FileZilla, VLC, OBS, Blender, and more...}
...
\cventry{2024--Pres}{Owner}{\textsc{Torode On The Road, LLC.}}{Austin, TX}{}{
	\begin{itemize}
		\item A multidisciplinary artisan and innovation startup.
