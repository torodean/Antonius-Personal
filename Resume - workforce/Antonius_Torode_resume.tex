...
Exceptionally well organized and resourceful professional with more than 10 year’s experience, with a solid academic background, excellent analytical and problem solving skills, and ability to handle multiple projects while producing high quality work. Strong problem-solving skills with experience developing software, designing algorithms, and implementing robust technical solutions.
...
\cvitem{Development Technologies}{\textsc{c}++, \textsc{python}, \textsc{java}, \textsc{git},  \textsc{bash}, \textsc{cmake}, \textsc{c}\#, \textsc{php}, \textsc{html}, \textsc{css}, \textsc{cad}, \LaTeX, Perforce, Qt, \textsc{root}, \textsc{geant4}, Eclipse, CLion, NetBeans, Cygwin, Makefiles, LabVIEW, Mathematica, TLS/SSL, Telnet, IBM MQ, Apache Pulsar, Systemd, GDB}
